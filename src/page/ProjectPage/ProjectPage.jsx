            ...
            <div className='projectPageContainer'>
                ...
                <div className='projectPageContent grid'>
                    ...
                    <div className='textSection'>
                        ...
                        <h3>Main Function.</h3>
                        <h5> + Login, logout.</h5>
                        <h5> + Register (registration confirmation via email).</h5>
                        ...
                        <h4>With User:</h4>
                        <h5> + Add product in cart and update in cart (redux)</h5>
                        <h5> + Payment via Paypal</h5>
